	...
	<div class="container">
		<div class="game-body">
			...
			<div class="game-container">
				<div class="game-message" :class="won?'game-won':''">
					<text class="over-msg">{{dataMsg}}</text>
					<div class="lower">
						<text class="retry-button" @click="restart">再试一次</text>
					</div>
				</div>
				<div class="game-message" :class="over?'game-over':''">
					<text class="over-msg">{{dataMsg}}</text>
					<div class="lower">
						<text class="retry-button" @click="restart">再试一次</text>
					</div>
				</div>
				<div class="grid-container" @touchstart="touchStart" @touchmove="touchMove" @touchend="touchEnd">
					<div v-for="row in grids" class="grid-row">
						<div v-for="item in row" class="grid-cell">
							<div :class="item!=null?'tile tile-'+item.value:''">
								<div v-if="item" class="tile-inner">
									{{item.value}}
								</div>
							</div>
						</div>
